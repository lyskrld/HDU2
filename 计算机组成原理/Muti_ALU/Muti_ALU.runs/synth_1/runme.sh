...
HD_PWD='D:/Computer_Organization/Muti_ALU/Muti_ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Muti_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Muti_ALU.tcl
