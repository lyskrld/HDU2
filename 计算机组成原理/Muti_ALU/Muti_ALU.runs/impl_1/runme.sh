...
HD_PWD='D:/Computer_Organization/Muti_ALU/Muti_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Muti_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Muti_ALU.tcl -notrace
