...
#
# Generated by export_simulation on Wed Jun 05 21:04:17 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './Rom_A.sh' script.
...
./Rom_A.sh -noclean_files

For more information on the script, please type './Rom_A.sh -help'.
