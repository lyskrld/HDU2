...
HD_PWD='D:/Computer_Organization/Test_7_Fetch_inst/Test_7_Fetch_inst/Test_7_Fetch_inst.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Inst_test7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fetch_Inst_test7.tcl -notrace
