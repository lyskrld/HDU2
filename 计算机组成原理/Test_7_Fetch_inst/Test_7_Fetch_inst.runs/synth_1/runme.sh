...
HD_PWD='D:/Computer_Organization/Test_7_Fetch_inst/Test_7_Fetch_inst/Test_7_Fetch_inst.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Inst_test7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fetch_Inst_test7.tcl
