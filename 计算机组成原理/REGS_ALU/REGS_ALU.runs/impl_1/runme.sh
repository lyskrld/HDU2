...
HD_PWD='D:/Computer_Organization/REGS_ALU/REGS_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log REGS_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source REGS_ALU.tcl -notrace
