...
HD_PWD='D:/Computer_Organization/REGS_ALU/REGS_ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log REGS_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source REGS_ALU.tcl
