...
HD_PWD='D:/Computer_Organization/CPU/CPU.runs/RAM_D_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_D.tcl
